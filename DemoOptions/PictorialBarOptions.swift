...
public final class PictorialBarOptions {
        ...
        return Option(
            ...
            .series([
                PictorialBarSerie(
                    ...
                    .markLine(MarkLine(
                        .symbol(.none),
                        .label(FormattedLabel(.normal(FormattedLabelStyle(.show(false))))),
        ...
        return Option(
            ...
            .series([
                PictorialBarSerie(
                    .name("hill"),
                    .barCategoryGap((-130)%),
                    .symbol(.path("path://M0,10 L10,10 C5.5,10 5.5,5 5,0 C4.5,5 4.5,10 0,10 z")),
                    .itemStyle(ItemStyle(
                        .normal(CommonItemStyleContent(
                            .opacity(0.5)
                            )),
                ...
                PictorialBarSerie(
                    ...
                    .data([
                        PictorialBarSerie.Data(
                            .value(123),
                            .symbol(.path(pathSymbols["reindeer"]!)),
                            .symbolSize([60, 60])
                        ),
                        PictorialBarSerie.Data(
                            .value(60),
                            .symbol(.path(pathSymbols["rocket"]!)),
                            .symbolSize([50, 60])
                        ),
                        PictorialBarSerie.Data(
                            .value(25),
                            .symbol(.path(pathSymbols["plane"]!)),
                            .symbolSize([65, 35])
                        ),
                        PictorialBarSerie.Data(
                            .value(18),
                            .symbol(.path(pathSymbols["train"]!)),
                            .symbolSize([50, 30])
                        ),
                        PictorialBarSerie.Data(
                            .value(12),
                            .symbol(.path(pathSymbols["ship"]!)),
                            .symbolSize([50, 35])
                        ),
                        PictorialBarSerie.Data(
                            .value(9),
                            .symbol(.path(pathSymbols["car"]!)),
                            .symbolSize([40, 30])
                        ),
                        PictorialBarSerie.Data(
                            .value(2),
                            .symbol(.path(pathSymbols["run"]!)),
                            .symbolSize([40, 50])
                        ),
                        PictorialBarSerie.Data(
                            .value(1),
                            .symbol(.path(pathSymbols["walk"]!)),
                            .symbolSize([40, 50])
                        )
                        ])
                )
    ...
    static func pictorialBarVehicleOption() -> Option {
        ...
        let labelSetting = EmphasisLabel(// FIXME: 缺少offset
            .normal(LabelStyle(
                .show(true),
                .position(.outside),
                .fontSize(6)
        ...
        return Option(
            ...
            .series([
                ...
                PictorialBarSerie(
                    ...
                    .label(EmphasisLabel( // FIXME: 缺少offset
                        .normal(LabelStyle(
                            .show(true),
                            .formatter(.function("function (params) {return (params.value / 2000 * 100).toFixed(1) + ' %';}")),
                            .position(.outside),
                            .color(.green),
                            .fontSize(18)
                            ))
    ...
    static func pictorialBarBodyFillOption() -> Option {
        ...
        let bodyMax = 150
        let labelSetting = EmphasisLabel(
            .normal(LabelStyle(// FIXME: 缺少offset
                .show(true),
                .position(.outside),
                .formatter(.function("function (param) {return (param.value / 150 * 100).toFixed(0) + '%';}")),
                .fontSize(18),
                .fontFamily("Arial")
                ))
        )
        let markLineSetting = MarkLine(
            .symbol(.none),
            .lineStyle(EmphasisLineStyle(
                .normal(LineStyle(
                    .opacity(0.3)
            ...
            .series([
                PictorialBarSerie(
                    ...
                    .data([
                        ...
                        PictorialBarSerie.Data(
                            .value(34),
                            .symbol(.path(symbols[1]))
                        ),
                        PictorialBarSerie.Data(
                            .value(101),
                            .symbol(.path(symbols[2]))
                        ),
                        PictorialBarSerie.Data(
                            .value(89),
                            .symbol(.path(symbols[3]))
                        ),
                        PictorialBarSerie.Data(
                            .value(72),
                            .symbol(.path(symbols[4]))
                        )
                        ]),
