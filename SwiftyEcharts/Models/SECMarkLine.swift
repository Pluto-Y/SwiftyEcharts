...
extension SECMarkLine.Data.DataContent : SECEnumable {
    public enum Enums {
        case type(Type), valueIndex(UInt), valueDim(String), coord(SECJsonable), x(Float), y(Float), value(Float), symbol(SECSymbol), symbolSize(Float), symbolRotate(Float), symbolOffset([Float]), lineStyle(SECCommonLineStyle), label(SECLabel)
    }
...
extension SECMarkLine.Data.DataContent : SECMappable {
...
extension SECMarkLine : SECEnumable {
    public enum Enums {
        case silent(Bool), symbol(SECSymbol), symbolSize(Float), precision(Float), label(SECLabel), lineStyle(SECCommonLineStyle), data(Data), animation(Bool), animationThreshold(Float), animationDuration(SECTime), animationEasing(SECAnimation), animationDelay(SECTime), animationDurationUpdate(SECTime), animationEasingUpdate(SECAnimation), animationDelayUpdate(SECTime)
    }
