...
public final class Echarts {
    public static let frameworkBundle = NSBundle(path: NSBundle.mainBundle().pathForResource("SwiftyEcharts", ofType: "framework", inDirectory: "Frameworks")!)!
