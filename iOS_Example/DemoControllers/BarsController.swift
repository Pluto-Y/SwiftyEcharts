...
class BarsController: BaseDemoController {
    ...
    override func viewDidLoad() {
       ...
       optionClosures = [BarOptions.barAnimationDelayOption, BarOptions.barBrushOption, BarOptions.barGradientOption, BarOptions.barNegativeOption, BarOptions.barNegative2Option, BarOptions.barStackOption, BarOptions.barTickAlignOption, BarOptions.barWaterfallOption, BarOptions.barWaterfall2Option, BarOptions.barYCategoryStackOption, BarOptions.barYCategoryOption, BarOptions.bar1Option, BarOptions.dynamicDataOption, BarOptions.mixLineBarOption, BarOptions.mixTimelineFinanceOption, BarOptions.mixZoomOnValueOption, BarOptions.multipleYAxisOption, BarOptions.watermarkOption]
